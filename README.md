...
- All of that sits on one setting — **CITY: OFF / CALM / NORMAL / LIVELY / MAYHEM** on the pause screen, LIVELY out of the box. Measured, four minutes a level with the player parked and doing nothing: 0, 1.3, 3.3, 6.5 and 10.8 fights a minute. OFF is not "calmer" — it is the game with none of this in it, brawl in progress called off and officers sent home, so it is an escape hatch as much as a preference.
