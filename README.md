...
- **And it is alive without you.** Strangers react to each other, not only to the player: a nudge from a car gets you a look or somebody at your window, a shove starts an argument, and the short-tempered go looking for one. Officers walk a beat while you are clean, turn up to other people's trouble and tell them to break it up — and none of it touches your wanted level, because a lively city that frames you for its own arguments is worse than a dead one. At the top of the range a few of them are carrying — and they will point it at you, if you are the one they are fighting. They are wilder shots than the police, though: about a quarter of their rounds land at twelve metres where an officer lands a third.
- All of that sits on one setting — **CITY: OFF / CALM / NORMAL / LIVELY / MAYHEM** on the pause screen, LIVELY out of the box. Measured while *driving*, which is how anyone actually plays: 0, 1.0, and 2.5 fights a minute at CALM and LIVELY, with MAYHEM running two and a half times the sustained brawling rather than simply starting more of them. Trouble only breaks out within sight — the crowd lives out to 180 m and a fight at that range is a fight nobody saw. OFF is not "calmer": it is the game with none of this in it, brawl in progress called off and officers sent home, so it is an escape hatch as much as a preference.
